...
% 2015-02-20
%   Ross Jones
%   Added better file existence checking
%
...
if (length(fcsheader_1stline) < 10)
    disp(fcsheader_1stline)
end
...
elseif strcmp(fcsheader_type,'FCS3.0') 
    ...
    elseif strcmp(mnemonic_separator,'/')
        ...
        elseif strcmp(fcshdr.datatype,'F')
            size1 = [fcshdr.NumOfPar fcshdr.TotalEvents];
            fcsdat = fread(fid,size1,'float32',machineformat)';
        end
    end
    fclose(fid);
end
